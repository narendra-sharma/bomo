        ...
        <div className="row mb-3">
          <div className="col-md-12 col-12">
            <div class="progress_bar">
                  ...
                  !expanddetails?.req_data?.brief_rejected_at && (
                    <div>
                      ...
                      <div class="deliver-status delivery-cancel">
                        <span>
                          {" "}
                          <i className="fa-solid fa-exclamation-circle cancel"></i>
                        </span>
                      </div>
                      <p className="brief-date">
              ...
              <div
                class={`${
                  expanddetails?.req_data?.brief_rejected_at ? "step" : ""
                }`}
              >
                {expanddetails?.req_data?.brief_rejected_at && (
                  <div>
          ...
          <div className="row review-content">
            ...
            <div class="col-md-12 col-lg-12">
              <div class=" d-flex align-items-center review-content ">
                ...
                <img
                  src={`${REACT_APP_BOMO_URL}${expanddetails?.req_data?.brand_profile?.logo}`}
                  alt="brand-profile"
                  className="logo-img"
                />
                <p
