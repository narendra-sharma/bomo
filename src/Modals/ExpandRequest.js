...
const ExpandRequest = ({
  ...
  return (
    <Modal
      ...
      onHide={handleClose}
      size="xl"
      className="expand-request view-as-customer-popup"
    >
            ...
            <div class="progress_bar">
              <div class="step">
                ...
                <p className="brief-date">
                  {expanddetails?.req_data?.createdAt
                    ? format(
                        new Date(expanddetails?.req_data?.createdAt),
                        "dd/MM/yyyy"
                      )
                    : "No Date"}
                  <span className="d-block">
                    {formattedTime(expanddetails?.req_data?.createdAt)}
                  </span>
                </p>
              </div>
              ...
              <div class="step">
                {expanddetails?.req_data?.brief_rejected_at && (
                  <div>
                    ...
                    <p className="brief-date">
                      {format(
                        new Date(expanddetails?.req_data?.brief_rejected_at),
                        "dd/MM/yyyy"
                      )}
                      <span className="d-block">
                        {formattedTime(
              ...
              <div
                class={`${
                  expanddetails?.req_data?.brief_approved_at ? "step" : ""
                }`}
              >
                {expanddetails?.req_data?.brief_approved_at && (
                  <div>
                    ...
                    <p className="brief-date">
                      {format(
                        new Date(expanddetails?.req_data?.brief_approved_at),
                        "dd/MM/yyyy"
                      )}
                      <span className="d-block">
                        {formattedTime(
              ...
              <div class="step">
                ...
                <div class="deliver-status delivery-request-count">
                  <span class="bg-white rounded-pill px-1">
                    {expanddetails?.req_data?.designer_list?.length} applicants
                  </span>
                </div>
                <p className="brief-date invisible">
                  16/03/2023 <span className="d-block">12:44</span>
                </p>
              </div>
              ...
              <div class="step">
                ...
                <p className="brief-date">
                  {expanddetails?.req_data?.req_mail_date ? (
                    <p className="brief-date">
                      {format(
                        new Date(expanddetails?.req_data?.req_mail_date),
                        "dd/MM/yyyy"
                      )}
                      <span className="d-block">
              ...
              <div class="step">
                {!expanddetails?.req_data?.is_approved_by_customer && (
                  <div>
                    ...
                    <p className="brief-date">
                      {expanddetails?.req_data?.design_rejected_at_by_customer
                        ? format(
                            new Date(
                              expanddetails?.req_data?.design_rejected_at_by_customer
                            ),
                      ...
                      <span className="d-block">
                        {expanddetails?.req_data?.design_rejected_at_by_customer
                          ? formattedTime(
                              expanddetails?.req_data
                                ?.design_rejected_at_by_customer
                            )
                          : ""}
                      </span>
                    </p>
        ...
        <div className="px-60 py-5 mx-3 review-main-content bg-white">
          <div className="row review-content">
            <div className="col-md-7">
              <div class="mb-3">
                <h3 class="fw-bold">{expanddetails?.req_data?.request_name}</h3>
              </div>
            </div>
            <div className="col-md-5">
              <div class="d-flex justify-content-end">
                <h5 class="fw-bold">$125</h5>
                <h6 class="text-end ps-5 fw-bold">
                  {" "}
                  Completed
                  <span class="d-block">Jan 20th</span>
                </h6>
              </div>
            </div>
            <div class="col-md-12 col-lg-12">
              <div class=" d-flex align-items-center review-content ">
                ...
                <p
                  class="short0ad project-assets rounded-pill"
                  onClick={() =>
                    handleDownload(
                      expanddetails?.req_data?.brand_profile?.brandassests
                    )
                  }
                >
                  Project Assets
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <p>
                          <span className="d-block">
                            {expanddetails?.req_data?.description}
                          </span>
                      ...
                      <td>
                        <p>{expanddetails?.req_data?.file_type}</p>
                      </td>
                      <td>
                        <p>{expanddetails?.req_data?.transparency}</p>{" "}
                      </td>
                      <td>
                        <p>{expanddetails?.req_data?.references}</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            {expanddetails?.delivery_data?.map((request, index) => (
              <div key={index}>
                    ...
                    <div className="row justify-content-center">
                      <div className="col-md-12 text-center mb-4">
                        ...
                        <p>
                          ...
                          <span className="ps-1 active-request-status fw-bold">
                            ON TIME
                          </span>
                        </p>
                      </div>
                      ...
                      <div className="col-md-3 d-flex text-center justify-content-center">
                        <div className="statusbar-section d-flex flex-column justify-content-between">
                          <div className="delivery-status fw-bold">
                            {" "}
                            {expanddetails?.req_data?.file_type}
                          </div>
                          <div className="">
                ...
                {request?.landscape_feedback_message ||
                request?.portrait_feedback_message ? (
                  <div className="col-md-12">
                    <div className="feedback-request  p-4 mt-4 rounded">
                      <h5 className="fw-bold">
                        Feedback {index + 1} Requested{" "}
                        {format(new Date(request?.createdAt), "dd/MM/yyyy")}{" "}
                        {formattedTime(request?.createdAt)}
                      </h5>
                      <p>
          ...
          {(expanddetails?.req_data?.landscape_feedback_message ||
            expanddetails?.req_data?.portrait_feedback_message) && (
            <div className="ready-to-delivery-section border border-dark p-5 bg-gray mt-4">
              <p>
                <span className="fw-bold">Ready to Deliver?</span> Place each
                file in its corresponding folder
              </p>
              <div className="row align-items-center">
                <div className="col-md-3 d-flex flex-column">
                  <h5 className="text-center">
                    <span className="uplaod-dimension border border-dark d-inline-block "></span>{" "}
                    Upload 9:16 .mp4
                  </h5>
                ...
                <div className="col-md-3 d-flex flex-column">
                  <h5 className="text-center">
                    <span className="uplaod-dimension sixteen-nine border border-dark d-inline-block"></span>{" "}
                    Upload 16:9 .mp4
                  </h5>
                  <div className="upload-nine-mp4">
                    <div className="d-flex align-item-center justify-content-center mb-4">
                ...
                <div className="col-md-3 d-flex flex-column">
                  <h5 className="text-center">.zip and upload your .AEP</h5>
                ...
                <div className="col-md-3">
                  <div class="status-btn">
                    <button class="btn pause-btn rounded-pill py-2 px-4">
                      DELIVERY NOW
                    </button>{" "}
                  </div>
                </div>
