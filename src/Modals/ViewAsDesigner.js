...
const ViewAsDesigner = ({ view, show, handleClose, user, designerdata }) => {
  const [isactive, setIsactive] = useState(
    designerdata?.designer_detail?.isDesignerApproved
  );
  ...
  return (
    <div>
              ...
              <div className="col-md-12 col-12">
                <p className="text-center mb-3">
                  <button
                    ...
                    onClick={() =>
                      handleswitchto_designer(
                        designerdata?.designer_detail?._id
                      )
                    }
                  >
                    View as designer
            ...
            <div className="row mx-auto justify-content-center">
                ...
                <div className="bg-white p-2 rounded d-flex flex-column h-100 justify-content-between">
                  ...
                  <div className="monthly-revenue-price text-center py-4">
                    <h2 className="text-dark mb-0">
                      ${designerdata?.pending_to_be_paid}
                    </h2>
                  </div>
                </div>
              </div>
              <div className="active-request-section d-flex flex-column rounded mb-4">
                <div className="bg-white p-2 rounded d-flex flex-column h-100 justify-content-between">
                  ...
                  <div className="monthly-revenue-price text-center py-4">
                    <h2 className="text-muted mb-0">
                      {designerdata?.number_of_requests_failed}
                    </h2>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="active-request-section d-flex flex-column rounded mb-4 col-md-2">
                <div className="bg-white p-2 rounded d-flex flex-column h-100 justify-content-between">
                  ...
                  <div className="monthly-revenue-price text-center py-4">
                    <h2 className="text-muted mb-0">
                      {designerdata?.number_of_applications}
                    </h2>
                  </div>
                </div>
              </div>
              <div className="active-request-section d-flex flex-column rounded mb-4 col-md-2">
                <div className="bg-white p-2 rounded d-flex flex-column h-100 justify-content-between">
                  ...
                  <div className="monthly-revenue-price text-center py-4">
                    <h2 className="text-muted mb-0">
                      {designerdata?.number_of_assigned_requests}
                    </h2>
                  </div>
                </div>
              </div>
              <div className="active-request-section d-flex flex-column rounded mb-4 col-md-2">
                <div className="bg-white p-2 rounded d-flex flex-column h-100 justify-content-between">
                  ...
                  <div className="monthly-revenue-price text-center py-4">
                    <h2 className="text-dark mb-0">
                      {designerdata?.number_of_requests_delivered}
                    </h2>
                  </div>
                </div>
              </div>
              <div className="active-request-section d-flex flex-column rounded mb-4 col-md-2">
                <div className="bg-white p-2 rounded d-flex flex-column h-100 justify-content-between">
                  ...
                  <div className="monthly-revenue-price text-center py-4">
                    <h2 className="text-muted mb-0">
                      {designerdata?.percentage_reviews_requested}%
                    </h2>
                  </div>
                </div>
              </div>
              <div className="active-request-section d-flex flex-column rounded mb-4 col-md-2">
                <div className="bg-white p-2 rounded d-flex flex-column h-100 justify-content-between">
                  ...
                  <div className="monthly-revenue-price text-center py-4">
                    <h2 className="text-muted mb-0">
                      {designerdata?.avg_req_completion_time} hours
                    </h2>
                  </div>
                </div>
              </div>
                ...
                <div className="review-main-content bg-white px-4 py-4 d-flex justify-content-between align-items-center rounded">
                    ...
                    <div className="d-flex align-items-center">
                      <div
                        style={{
                          width: 30,
                          height: 30,
                          backgroundColor: designerdata?.designer_detail?.colour
                            ? designerdata?.designer_detail?.colour
                            : "#000000",
                          borderRadius: 15,
                        }}
                      ></div>
                      <div className="">
                        <p className="mb-0 user-email ms-1 ms-lg-3">
                          ...
                          <span className="d-block">{designerdata?.name}</span>
                        </p>
                      </div>
                      <div className="">
                        <p className="mb-0 user-email ms-1 ms-lg-3">
                          <b className=" d-md-block">Email</b>
                          <span className="d-block">{designerdata?.email}</span>
                        </p>
                      </div>
                      <div className="">
                        <p className="mb-0 user-email ms-1 ms-lg-3">
                  ...
                  <div className="col-md-3">
                    <p className="mb-0 user-email ms-1 ms-lg-3 text-end">
                      ...
                      <span className="d-block">
                        {designerdata?.signup_date
                          ? format(
                              new Date(designerdata?.signup_date),
                              "dd/MM/yyyy"
                            )
                          : "No Date"}
                      </span>
                ...
                <div className="row reel-data review-content">
                  ...
                  <div className="col-md-9 col-lg-9">
                    <p className="text-mute">
                      {designerdata?.designer_detail?.bio}
                    </p>
                  </div>
                  <div className="col-md-3 col-lg-3">
                  ...
                  <div className="col-md-9 col-lg-9">
                    <p className="">
                      <Link
                        ...
                        to={`${designerdata?.designer_detail?.website}`}
                        target="_blank"
                      >
                        {designerdata?.designer_detail?.website
                          ? designerdata?.designer_detail?.website
                          : ""}
                      </Link>{" "}
                    </p>
                  ...
                  <div className="col-md-9 col-lg-9">
                    <p className="">
                      <Link
                        className="text-decoration-none"
                        to={`${designerdata?.designer_detail?.instagram}`}
                        target="_blank"
                      >
                        {designerdata?.designer_detail?.instagram
                          ? designerdata?.designer_detail?.instagram
                          : ""}
                      </Link>
                    </p>
                  ...
                  <div className="col-md-9 col-lg-9">
                    <p className="">
                      <Link
                        className="text-decoration-none"
                        to={`${designerdata?.designer_detail?.behance}`}
                        target="_blank"
                      >
                        {designerdata?.designer_detail?.behance
                          ? designerdata?.designer_detail?.behance
                          : ""}
                      </Link>
                    </p>
      ...
      <ApproveDesigner
        isview={isview}
        viewClose={() => setIsview(false)}
        details={designerdata}
        designerstatus={isactive}
      />
    </div>
  );
};
