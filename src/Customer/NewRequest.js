                  ...
                  <div className="row">
                    <div className="col-md-5">
                      <div className="form-group">
                        ...
                        <input type="text" name="requestName" className="form-control" defaultValue={formData?.requestName} onChange={handleInputChange} onInput={handleInputChange}/>
                    ...
                    <div className="col-md-12">
                      <div className="form-group">
                        ...
                        <textarea name="description" className="form-control w-100" placeholder="Describe the brief for this piece. Include as much info as possible. Tone and Style, Target Audience, Goal of the Piece, Display Platform, Duration." defaultValue={formData?.description} onChange={handleInputChange} onInput={handleInputChange}></textarea>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input type="text" name="references" className="form-control" defaultValue={formData?.references} onChange={handleInputChange} onInput={handleInputChange}/>
